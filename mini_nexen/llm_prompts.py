    ...
    payload = {
        ...
        "instructions": {
            ...
            "profile_guidance": [
                ...
                "Do not place [關切] or [關切證據] tags in Notes; keep Notes free of profile tags.",
                "Profile-tagged ties should appear in the Research Plan outline steps rather than in Notes.",
