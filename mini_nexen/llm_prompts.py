    ...
    payload = {
        ...
        "instructions": {
            ...
            "profile_guidance": [
                ...
                "Do not add [關切] or [關切證據] tags anywhere in the plan output; these tags are reserved for the Research Plan outline.",
    ...
    payload = {
        ...
        "instructions": {
            ...
            "profile_guidance": [
                ...
                "When profile_summary is provided, each top-layer step must include at least one [關切] or [關切證據] tag.",
                ...
                "Use [關切] when the tie is contextual or inferred without direct evidence; reserve [關切證據] for clear evidence alignment.",
    ...
    payload = {
        ...
        "instructions": {
            ...
            "requirements": [
                ...
                "If any top-layer step lacks a [關切] or [關切證據] tag when profile_summary is provided, include a suggested_addition and set needs_revision to true.",
    ...
    payload = {
        ...
        "instructions": {
            ...
            "requirements": [
                ...
                "If [關切證據] appears without aligned evidence, advise downgrading to [關切] and provide feedback.",
                "If validation.warnings include missing_profile_tags, set action to outline_retry and request [關切]/[關切證據] tags in top-layer steps.",
